...
**In summary**, the XGBoost model shows promising underlying structure with strong class separability. With targeted refinements, its classification reliability can likely be improved substantially [@Geron2019].
...
In summary, the sensitivity and robustness metrics indicate that the model behaves **consistently across perturbations**, with high performance and acceptable variability. This supports confidence in the model’s generalizability and stability for practical use [@Geron2019].
