...
base_tbl <- metrics(test_results,
                    truth = Expert.Diagnose,
                    estimate = .pred_class)

roc_tbl <- roc_auc(test_results,
                   truth = Expert.Diagnose,
                   all_of(prob_cols),
                   estimator = "macro_weighted") %>%
...
# Merge Table
kable(bind_rows(base_tbl, roc_tbl),
      format = "markdown",
      caption = "Classification Metrics Including Macro-Weighted ROC AUC",
      digits = 3)
